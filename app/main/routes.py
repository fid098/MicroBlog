...
def index():
    ...
    return render_template('index.html', title=_('Home'), form=form,
                           ...
                           prev_url=prev_url, delete_form=EmptyForm())
...
def explore():
    ...
    # Reuses index.html without the post form
    return render_template('index.html', title=_('Explore'), next_url=next_url,
                           prev_url=prev_url, posts=posts.items, delete_form=EmptyForm())
...
def user(username):
    ...
    form = EmptyForm()
    return render_template('user.html', form=form, posts=posts.items,
                           next_url=next_url, prev_url=prev_url,
                           user=user, delete_form=form)
...
def send_message(recipient):
    ...
    return render_template('send_messages.html', title=_('Send Message'),
...
@login_required
def notifications():
    # `since` param prevents re-fetching already-seen notifications
